...
class ResponseUtils:
    ...
    def check_authorization(self,context, required_groups=None):
    ...
    def authorize(self, context, required_groups=None):
        ...
        if not self.check_authorization(request_context, required_groups):
    ...
    def error_response(self, status_code, message):
        ...
        return self.create_response(status_code, {'error': message})
